...
def get_oasst1(
    ...
    datasets.config.DOWNLOADED_DATASETS_PATH = "~/../../scratch/sbongni/.cache/huggingface/downloads"
    dataset = datasets.load_dataset("OpenAssistant/oasst1", verification_mode="no_checks")
